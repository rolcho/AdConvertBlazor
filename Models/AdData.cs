...
public class AdData
{
    ...
    public static readonly Dictionary<AdType, string> styles = new Dictionary<AdType, string>()
    {
        ...
        { AdType.Header, "p-4 bg-red-600 text-white w-full text-center uppercase border-b-4 border-black w-full" },
